/**
  ******************************************************************************
  * @file    Dual_AlternateTrigger/src/main.c
...
__IO uint16_t   ADC1_InjectedConvertedValueTab[64];
__IO uint16_t   ADC2_InjectedConvertedValueTab[64];
...
int main(void)
{
  ...
  /* ADC1 injected channel Configuration on ADC1 */ 
  ADC_InjectedChannelConfig(ADC1, ADC_Channel_14, 1, ADC_SampleTime_7Cycles5);
  ...
  /* Enable ADC2 injected external trigger conversion */
  ADC_ExternalTrigInjectedConvCmd(ADC2, ENABLE);

  /* Enable JEOC interupt on ADC1 */
  ADC_ITConfig(ADC1, ADC_IT_JEOC, ENABLE);
  
  /* Enable JEOC interupt on ADC2 */
  ...
  /* Wait for ADC1 and ADC2 values to be converted */
...
void GPIO_Configuration(void)
{
  ...
  /* Configure TIM1_CH4 (PA.11) as alternate function push-pull */
