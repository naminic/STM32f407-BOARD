/**
  @page Dual_SlowInterleaved AN3116 Dual_SlowInterleaved Readme file
 ...
 * @version  V1.0.0
 * @date     03/09/2010
 * @brief    Description of the AN3116 Application note's Dual_SlowInterleaved.
 ********************************************************************************
...
This example describes how to use the ADC in Dual Slow Interleaved mode. 
ADC1 and ADC2 convert alternately the same ADC channel (channel11) with a period 
of 14 ADC clock cycles. The sampling rate of the conversion of channel11 is 1Msample/s.
...
@par Directory contents 
  ...
  - Dual_SlowInterleaved/inc/stm32f10x_conf.h  Library Configuration file
  - Dual_SlowInterleaved/src/stm32f10x_it.c    Interrupt handlers
  - Dual_SlowInterleaved/inc/stm32f10x_it.h    Interrupt handlers header file
  - Dual_SlowInterleaved/src/main.c            Main program
...
@par Hardware and Software environment
  ...
  - STM3210B-EVAL, STM3210E-EVAL and  STM3210C-EVAL Set-up  
    - Connect an external voltage (0-3.3v) to channel11 (GPIOC.01). The source can be a power
      supply or a GBF (it's preferable to use 50kHz frequency to well recover the signal).
      Note: the peak to peak amplitude of the signal should be in the range of 0v to 3.3v.
  
      
@par How to use it 

In order to load the Dual_SlowInterleaved project, you have to do the
following:
